...
export function essayCommand(topic: string, level: number): string {
  ...
  const schema =
    '{"essay":"toàn bộ bài essay (có thể nhiều đoạn, ngăn cách bằng \\n\\n)","vocab":[{"word":"MỘT từ đơn tiếng Anh","pos":"loại từ: noun/verb/adjective/adverb…","ipa":"phiên âm /.../","short":"nghĩa NGẮN GỌN 1-4 từ tiếng Việt","meaning":"nghĩa tiếng Việt CHI TIẾT: giải thích đầy đủ nghĩa cốt lõi + sắc thái/ngữ cảnh dùng trong bài, khoảng 1 câu ngắn (KHÔNG dịch cụt lủn 1-2 từ)","example":"câu ví dụ tiếng Anh dùng từ này"}],"families":[{"root":"từ gốc","members":[{"word":"dạng từ","pos":"noun/verb/adjective/adverb","meaning":"nghĩa tiếng Việt"}]}]}';
  return [
    `/essay ${topic} ${level}`,
    "",
    ...
    schema,
    // Sinh DƯ (14-18) để client lọc bỏ từ đã học mà vẫn còn đủ từ mới hiển thị.
    `"vocab": 14-18 TỪ ĐƠN quan trọng XUẤT HIỆN trong bài — mỗi mục PHẢI là MỘT từ duy nhất (TUYỆT ĐỐI không cụm từ, từ ghép nhiều chữ, hay phrasal verb), KHÔNG trùng lặp; kèm "pos" (loại từ), "ipa", "short", "meaning", "example". Trường "short" là nghĩa NGẮN GỌN tối đa 4 từ (để nhớ nhanh); "meaning" phải CHI TIẾT: nêu nghĩa cốt lõi kèm sắc thái/ngữ cảnh từ được dùng trong bài (khoảng 1 câu ngắn), nếu từ có nhiều nghĩa phổ biến thì nói rõ nghĩa dùng ở đây; TRÁNH dịch cụt lủn kiểu 1-2 từ.`,
